      ...
      <div className="mx-auto grid min-h-[650px] max-w-7xl items-center gap-14 px-6 py-16 lg:grid-cols-[1.05fr_.95fr] lg:px-8 lg:py-24">
        <div className="order-2 lg:order-1">
          <span className="theme-border theme-muted inline-flex rounded-full border bg-white/5 px-4 py-2 text-xs font-bold backdrop-blur">
            انتخاب‌های تازه برای سبک زندگی امروز
          </span>
          <h1 className="theme-text mt-6 max-w-2xl text-5xl font-black leading-[1.15] tracking-tight sm:text-6xl">
            چیزهای خوب،
            <span className="theme-muted mt-2 block">ساده‌تر انتخاب می‌شوند.</span>
          </h1>
          ...
          <div className="mt-9 flex flex-col gap-3 sm:flex-row">
            <a href="#products" className="theme-primary-button rounded-full px-7 py-3.5 text-center text-sm font-bold transition hover:-translate-y-0.5 hover:opacity-90">
              مشاهده محصولات
            </a>
            <Link href="/login" className="theme-secondary-button rounded-full border px-7 py-3.5 text-center text-sm font-bold transition">
              حساب کاربری من
            </Link>
          </div>
        ...
        <div className="order-1 lg:order-2">
          <div className="theme-surface relative mx-auto aspect-square max-w-xl overflow-hidden rounded-[2rem] border p-6 shadow-2xl shadow-black/30" style={{ borderColor: "var(--border)" }}>
